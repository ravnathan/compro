...
export default function Footer() {
    return (
        <footer className=" footer footer-center bg-green-950 text-white p-10">
            <aside>
                <Image src={"/detealogowhite.svg"} width={100} height={1000} alt="DeTea Icon" />
                <br />
                <p className="font-bold">
                    Providing high-quality tea since 1947
                </p>
            ...
            <nav>
                <div className="grid grid-flow-col gap-4">
                    ...
                    <Link href={"https://id-id.facebook.com/"} aria-label="Facebook">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
