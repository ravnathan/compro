    ...
    return (
        <div className="w-full sticky top-0 z-30">
            <div className="flex justify-between items-center px-10 h-14 bg-green-950">
                ...
                <button onClick={() => setHambur(!false)} className="lg:hidden text-white"><svg width={40} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M3 4H21V6H3V4ZM3 11H21V13H3V11ZM3 18H21V20H3V18Z"></path></svg></button>
            </div>
